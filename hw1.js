...
const Product = class Product {
    ...
    constructor(str){
        const prdocutInfo = str.split(",")
        this.name = prdocutInfo[0];
        this.price = parseFloat(prdocutInfo[1]);
        this.availability = prdocutInfo[2];
    }
    /**
     * *****************
     * ***** TODO ******
    ...
    static printProducts = (products) => {
        products.forEach(product => {
            ...
            console.log(`Product: ${name}, Cost: ${formattedPrice}, Availability: ${availability === 'In Stock'? "Yes" : "No"}`);
        })
    }
